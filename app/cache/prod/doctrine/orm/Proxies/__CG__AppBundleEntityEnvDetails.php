 ...
 */
class EnvDetails extends \AppBundle\Entity\EnvDetails implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\EnvDetails' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\EnvDetails' . "\0" . 'servertype', '' . "\0" . 'AppBundle\\Entity\\EnvDetails' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\EnvDetails' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\EnvDetails' . "\0" . 'environment', '' . "\0" . 'AppBundle\\Entity\\EnvDetails' . "\0" . 'server'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EnvDetails $proxy) {
